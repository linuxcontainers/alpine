...
##### Alpine Version 3.15.2 (Released March 23, 2022)
...
* Tags of the form MAJOR.MINOR.PATCH (such as 3.15.2) indicate the SemVer of 
  the __Alpine__ image used as the base.
* Tags of the form MAJOR.MINOR (e.g., 3.13) correspond to the most recent patch level of
  the __Alpine__ image used as the base. For example, if 3.15.2 is the latest
...
* Tags of the form MAJOR (e.g., 3) correspond to the most recent patch level of
  ...
  For example, if 3.15.2 is the latest release, then 3 maps to this as well.
