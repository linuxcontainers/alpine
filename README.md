...
##### Alpine Version 3.14.3 (Released November 12, 2021)
...
* Tags of the form MAJOR.MINOR (e.g., 3.13) correspond to the most recent patch level of
  the __Alpine__ image used as the base. For example, if 3.14.3 is the latest
...
* Tags of the form MAJOR (e.g., 3) correspond to the most recent patch level of
  ...
  For example, if 3.14.3 is the latest release, then 3 maps to this as well.
